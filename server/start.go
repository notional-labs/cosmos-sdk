...
`,
	...
	// cmd.Flags().Uint(FlagInterBlockCacheSize, cache.DefaultCommitKVStoreCacheSize, "The size of inter-block caching store") //commented out by Jacob Gadikian as part of the dragonberry patch.
