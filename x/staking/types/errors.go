...
var (
	...
	ErrNotEnoughBalance                 = sdkerrors.New(ModuleName, 41, "not enough balance")
	ErrTokenizeShareRecordNotExists     = sdkerrors.New(ModuleName, 42, "tokenize share record not exists")
	ErrTokenizeShareRecordAlreadyExists = sdkerrors.New(ModuleName, 43, "tokenize share record already exists")
	ErrNotTokenizeShareRecordOwner      = sdkerrors.New(ModuleName, 44, "not tokenize share record owner")
	ErrExceedingFreeVestingDelegations  = sdkerrors.New(ModuleName, 45, "trying to exceed vested free delegation for vesting account")
	ErrOnlyBondDenomAllowdForTokenize   = sdkerrors.New(ModuleName, 46, "only bond denom is allowed for tokenize")
)
