...
func setupTest(height int64, skip map[int64]bool) TestSuite { //nolint:unparam
	db := dbm.NewMemDB()
	...
	s.querier = s.module.LegacyQuerierHandler(app.LegacyAmino()) //nolint:staticcheck // LegacyQuerierHandler is deprecated
