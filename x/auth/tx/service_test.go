...
import (
	...
	authtest "github.com/cheqd/cosmos-sdk/x/auth/client/testutil"
	bankcli "github.com/cheqd/cosmos-sdk/x/bank/client/testutil"
	...
	for _, tc := range testCases {
		s.Run(tc.name, func() {
			...
			if tc.expErr {
				...
				// ref: https://github.com/cheqd/cosmos-sdk/issues/8680
				// ref: https://github.com/cheqd/cosmos-sdk/issues/8681
