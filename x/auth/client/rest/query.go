...
import (
	...
	clientrest "github.com/cheqd/cosmos-sdk/client/rest"
	...
	genutilrest "github.com/cheqd/cosmos-sdk/x/genutil/client/rest"
)
...
func QueryAccountRequestHandlerFn(storeName string, clientCtx client.Context) http.HandlerFunc {
	return func(w http.ResponseWriter, r *http.Request) {
		...
		if err != nil {
			...
			// Ref: https://github.com/cheqd/cosmos-sdk/issues/4923
