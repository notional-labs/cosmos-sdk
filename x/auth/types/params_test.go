...
func TestParams_Validate(t *testing.T) {
	tests := []struct {
		...
		{"invalid tx signature limit", types.NewParams(types.DefaultMaxMemoCharacters, 0, types.DefaultTxSizeCostPerByte,
			types.DefaultSigVerifyCostED25519, types.DefaultSigVerifyCostSecp256k1, types.DefaultTxFeeBurnPercent), fmt.Errorf("invalid tx signature limit: 0")},
		{"invalid ED25519 signature verification cost", types.NewParams(types.DefaultMaxMemoCharacters, types.DefaultTxSigLimit, types.DefaultTxSizeCostPerByte,
			0, types.DefaultSigVerifyCostSecp256k1, types.DefaultTxFeeBurnPercent), fmt.Errorf("invalid ED25519 signature verification cost: 0")},
		{"invalid SECK256k1 signature verification cost", types.NewParams(types.DefaultMaxMemoCharacters, types.DefaultTxSigLimit, types.DefaultTxSizeCostPerByte,
			types.DefaultSigVerifyCostED25519, 0, types.DefaultTxFeeBurnPercent), fmt.Errorf("invalid SECK256k1 signature verification cost: 0")},
		{"invalid max memo characters", types.NewParams(0, types.DefaultTxSigLimit, types.DefaultTxSizeCostPerByte,
			types.DefaultSigVerifyCostED25519, types.DefaultSigVerifyCostSecp256k1, types.DefaultTxFeeBurnPercent), fmt.Errorf("invalid max memo characters: 0")},
		...
		{"invalid tx fee burn percent", types.NewParams(types.DefaultMaxMemoCharacters, types.DefaultTxSigLimit, types.DefaultTxSizeCostPerByte,
			types.DefaultSigVerifyCostED25519, types.DefaultSigVerifyCostSecp256k1, 101), fmt.Errorf("tx fee burn percent cannot be greater than 100%%: 101")},
	}
