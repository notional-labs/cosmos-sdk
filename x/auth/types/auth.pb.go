...
type Params struct {
	...
	TxFeeBurnPercent       uint64 `protobuf:"varint,6,opt,name=tx_fee_burn_percent,json=txFeeBurnPercent,proto3" json:"tx_fee_burn_percent,omitempty" yaml:"tx_fee_burn_percent"`
}
...
func (m *Params) GetTxFeeBurnPercent() uint64 {
	if m != nil {
...
var fileDescriptor_7e1f7e915d020d2d = []byte{
	...
	,
}
...
func (this *Params) Equal(that interface{}) bool {
	...
	if this.TxFeeBurnPercent != that1.TxFeeBurnPercent {
		return false
	}
	return true
}
...
func (m *Params) MarshalToSizedBuffer(dAtA []byte) (int, error) {
	...
	var l int
	_ = l
	if m.TxFeeBurnPercent != 0 {
		i = encodeVarintAuth(dAtA, i, uint64(m.TxFeeBurnPercent))
		i--
		dAtA[i] = 0x30
	}
...
func (m *Params) Size() (n int) {
	...
	if m.TxFeeBurnPercent != 0 {
		n += 1 + sovAuth(uint64(m.TxFeeBurnPercent))
	}
	return n
}
	...
	for iNdEx < l {
		...
		case 6:
			...
			for shift := uint(0); ; shift += 7 {
				...
				b := dAtA[iNdEx]
				iNdEx++
				m.TxFeeBurnPercent |= uint64(b&0x7F) << shift
				if b < 0x80 {
					break
				}
			}
