...
var (
	...
	fd_MsgChangePubKey_pub_key protoreflect.FieldDescriptor
)

func init() {
	file_cosmos_rekeying_v1beta1_tx_proto_init()
	md_MsgChangePubKey = File_cosmos_rekeying_v1beta1_tx_proto.Messages().ByName("MsgChangePubKey")
	fd_MsgChangePubKey_address = md_MsgChangePubKey.Fields().ByName("address")
	fd_MsgChangePubKey_pub_key = md_MsgChangePubKey.Fields().ByName("pub_key")
}
...
func (x *MsgChangePubKey) slowProtoReflect() protoreflect.Message {
	mi := &file_cosmos_rekeying_v1beta1_tx_proto_msgTypes[0]
...
func (x *fastReflection_MsgChangePubKey) Range(f func(protoreflect.FieldDescriptor, protoreflect.Value) bool) {
	...
	if x.PubKey != nil {
		...
		if !f(fd_MsgChangePubKey_pub_key, value) {
			return
		}
	}
}
...
func (x *fastReflection_MsgChangePubKey) Has(fd protoreflect.FieldDescriptor) bool {
	switch fd.FullName() {
	case "cosmos.rekeying.v1beta1.MsgChangePubKey.address":
		return x.Address != ""
	case "cosmos.rekeying.v1beta1.MsgChangePubKey.pub_key":
		return x.PubKey != nil
	default:
		if fd.IsExtension() {
			panic(fmt.Errorf("proto3 declared messages do not support extensions: cosmos.rekeying.v1beta1.MsgChangePubKey"))
		}
		panic(fmt.Errorf("message cosmos.rekeying.v1beta1.MsgChangePubKey does not contain field %s", fd.FullName()))
	}
}
...
func (x *fastReflection_MsgChangePubKey) Get(descriptor protoreflect.FieldDescriptor) protoreflect.Value {
	...
	default:
		...
		panic(fmt.Errorf("message cosmos.rekeying.v1beta1.MsgChangePubKey does not contain field %s", descriptor.FullName()))
	}
}
...
func (x *fastReflection_MsgChangePubKey) Mutable(fd protoreflect.FieldDescriptor) protoreflect.Value {
	...
	case "cosmos.rekeying.v1beta1.MsgChangePubKey.address":
		panic(fmt.Errorf("field address of message cosmos.rekeying.v1beta1.MsgChangePubKey is not mutable"))
	default:
		if fd.IsExtension() {
			panic(fmt.Errorf("proto3 declared messages do not support extensions: cosmos.rekeying.v1beta1.MsgChangePubKey"))
		}
...
func (x *fastReflection_MsgChangePubKey) WhichOneof(d protoreflect.OneofDescriptor) protoreflect.FieldDescriptor {
	switch d.FullName() {
	default:
		panic(fmt.Errorf("%s is not a oneof field in cosmos.rekeying.v1beta1.MsgChangePubKey", d.FullName()))
	}
	panic("unreachable")
}
...
func init() {
	file_cosmos_rekeying_v1beta1_tx_proto_init()
	md_MsgChangePubKeyResponse = File_cosmos_rekeying_v1beta1_tx_proto.Messages().ByName("MsgChangePubKeyResponse")
}
...
func (x *MsgChangePubKeyResponse) slowProtoReflect() protoreflect.Message {
	mi := &file_cosmos_rekeying_v1beta1_tx_proto_msgTypes[1]
	if protoimpl.UnsafeEnabled && x != nil {
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		if ms.LoadMessageInfo() == nil {
			ms.StoreMessageInfo(mi)
...
func (x *fastReflection_MsgChangePubKeyResponse) Has(fd protoreflect.FieldDescriptor) bool {
	...
	default:
		if fd.IsExtension() {
			panic(fmt.Errorf("proto3 declared messages do not support extensions: cosmos.rekeying.v1beta1.MsgChangePubKeyResponse"))
		}
		panic(fmt.Errorf("message cosmos.rekeying.v1beta1.MsgChangePubKeyResponse does not contain field %s", fd.FullName()))
	}
}
...
func (x *fastReflection_MsgChangePubKeyResponse) Get(descriptor protoreflect.FieldDescriptor) protoreflect.Value {
	...
	default:
		...
		panic(fmt.Errorf("message cosmos.rekeying.v1beta1.MsgChangePubKeyResponse does not contain field %s", descriptor.FullName()))
	}
}
...
func (x *fastReflection_MsgChangePubKeyResponse) WhichOneof(d protoreflect.OneofDescriptor) protoreflect.FieldDescriptor {
	switch d.FullName() {
	default:
		panic(fmt.Errorf("%s is not a oneof field in cosmos.rekeying.v1beta1.MsgChangePubKeyResponse", d.FullName()))
	}
	panic("unreachable")
}
...
func (*MsgChangePubKey) Descriptor() ([]byte, []int) {
	return file_cosmos_rekeying_v1beta1_tx_proto_rawDescGZIP(), []int{0}
}
...
func (x *MsgChangePubKey) GetPubKey() *anypb.Any {
	if x != nil {
		return x.PubKey
	}
	return nil
...
func (*MsgChangePubKeyResponse) Descriptor() ([]byte, []int) {
	return file_cosmos_rekeying_v1beta1_tx_proto_rawDescGZIP(), []int{1}
}

var File_cosmos_rekeying_v1beta1_tx_proto protoreflect.FileDescriptor

var file_cosmos_rekeying_v1beta1_tx_proto_rawDesc = []byte{
	0x0a, 0x20, 0x63, 0x6f, 0x73, 0x6d, 0x6f, 0x73, 0x2f, 0x72, 0x65, 0x6b, 0x65, 0x79, 0x69, 0x6e,
	0x67, 0x2f, 0x76, 0x31, 0x62, 0x65, 0x74, 0x61, 0x31, 0x2f, 0x74, 0x78, 0x2e, 0x70, 0x72, 0x6f,
	0x74, 0x6f, 0x12, 0x17, 0x63, 0x6f, 0x73, 0x6d, 0x6f, 0x73, 0x2e, 0x72, 0x65, 0x6b, 0x65, 0x79,
	...
	0x79, 0x2e, 0x70, 0x72, 0x6f, 0x74, 0x6f, 0x22, 0xa3, 0x01, 0x0a, 0x0f, 0x4d, 0x73, 0x67, 0x43,
	0x68, 0x61, 0x6e, 0x67, 0x65, 0x50, 0x75, 0x62, 0x4b, 0x65, 0x79, 0x12, 0x32, 0x0a, 0x07, 0x61,
	...
	,
	...
	,
}

var (
	file_cosmos_rekeying_v1beta1_tx_proto_rawDescOnce sync.Once
	file_cosmos_rekeying_v1beta1_tx_proto_rawDescData = file_cosmos_rekeying_v1beta1_tx_proto_rawDesc
)

func file_cosmos_rekeying_v1beta1_tx_proto_rawDescGZIP() []byte {
	file_cosmos_rekeying_v1beta1_tx_proto_rawDescOnce.Do(func() {
		file_cosmos_rekeying_v1beta1_tx_proto_rawDescData = protoimpl.X.CompressGZIP(file_cosmos_rekeying_v1beta1_tx_proto_rawDescData)
	})
	return file_cosmos_rekeying_v1beta1_tx_proto_rawDescData
}

var file_cosmos_rekeying_v1beta1_tx_proto_msgTypes = make([]protoimpl.MessageInfo, 2)
var file_cosmos_rekeying_v1beta1_tx_proto_goTypes = []interface{}{
	(*MsgChangePubKey)(nil),         // 0: cosmos.rekeying.v1beta1.MsgChangePubKey
	(*MsgChangePubKeyResponse)(nil), // 1: cosmos.rekeying.v1beta1.MsgChangePubKeyResponse
	(*anypb.Any)(nil),               // 2: google.protobuf.Any
}
var file_cosmos_rekeying_v1beta1_tx_proto_depIdxs = []int32{
	2, // 0: cosmos.rekeying.v1beta1.MsgChangePubKey.pub_key:type_name -> google.protobuf.Any
	0, // 1: cosmos.rekeying.v1beta1.Msg.ChangePubKey:input_type -> cosmos.rekeying.v1beta1.MsgChangePubKey
	1, // 2: cosmos.rekeying.v1beta1.Msg.ChangePubKey:output_type -> cosmos.rekeying.v1beta1.MsgChangePubKeyResponse
...
func init() { file_cosmos_rekeying_v1beta1_tx_proto_init() }
func file_cosmos_rekeying_v1beta1_tx_proto_init() {
	if File_cosmos_rekeying_v1beta1_tx_proto != nil {
		return
	}
	if !protoimpl.UnsafeEnabled {
		file_cosmos_rekeying_v1beta1_tx_proto_msgTypes[0].Exporter = func(v interface{}, i int) interface{} {
		...
		file_cosmos_rekeying_v1beta1_tx_proto_msgTypes[1].Exporter = func(v interface{}, i int) interface{} {
	...
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			...
			RawDescriptor: file_cosmos_rekeying_v1beta1_tx_proto_rawDesc,
			NumEnums:      0,
			NumMessages:   2,
			NumExtensions: 0,
			NumServices:   1,
		},
		GoTypes:           file_cosmos_rekeying_v1beta1_tx_proto_goTypes,
		DependencyIndexes: file_cosmos_rekeying_v1beta1_tx_proto_depIdxs,
		MessageInfos:      file_cosmos_rekeying_v1beta1_tx_proto_msgTypes,
	}.Build()
	File_cosmos_rekeying_v1beta1_tx_proto = out.File
	file_cosmos_rekeying_v1beta1_tx_proto_rawDesc = nil
	file_cosmos_rekeying_v1beta1_tx_proto_goTypes = nil
	file_cosmos_rekeying_v1beta1_tx_proto_depIdxs = nil
}
